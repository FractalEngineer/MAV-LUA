...
echo   WIDGETS\MAV\
echo.
echo The MAVLUA_BUILD_INDEX files are listed in case a card holds them from an earlier
echo build that was withdrawn. They are not part of the current package, and removing
echo them if they are absent does nothing.
echo.
